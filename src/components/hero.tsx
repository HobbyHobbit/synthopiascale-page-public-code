  ...
  const heroTracks = useMemo(() => [
    {
      ...
      src: "/preview-tracks/Intro-Track/SynthopiaScale Records - Climbing the Scale Together.wav",
    },
    {
      id: 101,
      title: "Let Them Collide (EN Edition)",
      artist: "SynthopiaScale Records",
      src: "/preview-tracks/Intro-Track/Let Them Collide (EN Edition).wav",
    },
    {
      id: 102,
      title: "Let Them Collide (GER Edition)",
      artist: "SynthopiaScale Records",
      src: "/preview-tracks/Intro-Track/Let Them Collide(GER Edition).wav",
    },
  ], [])
